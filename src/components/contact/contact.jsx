...
import ContactBackground from '../../assets/contact/abogado.jpg';
...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    let API_KEY = "user_uDx9lMbym3N6BUNboX90x";
    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <p className="font12">
            Contáctese hoy con nuestro equipo de profesionales, responderemos su consulta a brevedad.
          </p>
          <p>Aclaración: debido a la nueva situación de pandemia que atraviesa nuestro país las citas serán coordinadas previamente con los profesionales. No se admitirán reunionés sin cita previa. </p>

          <Row className="padding40">
            <Col md={12} lg={6}>
              <form id="contact-form" onSubmit={this.handleSubmit}>
                <h4 className="font30 weight800 padding30">ESCRIBENOS</h4>
            ...
            <Col md={12} lg={6}>
              <div className="flex-center">
                <img src={ContactBackground} alt="contact background" className="imagenes" />
              </div>
            </Col>
          </Row>
          <ContactInfo />
