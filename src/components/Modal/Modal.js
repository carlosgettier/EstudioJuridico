...
export const Modal = () => {
    return (
        <div className="modales" id="Modal">
            ...
            <ul>
                <li>
                    <p>•  Indemnización por despido – enfermedad – accidente laboral</p>
                </li>
                <li>
                    <p>•  Despidos</p>
                </li>
                <li>
                    <p>•  Trabajo en Negro</p>
                </li>
                <li>
                ...
                <li>
                    <p>•  Diferencias Salariales</p>
                </li>
                <li>
                    <p>•  Mala / Deficiente Registración Laboral (Salario- Categoría – Jornada) </p>
                </li>
                <li>
                    <p>•  Horas Extras impagas</p>
                </li>
                <li>
                    <p>•  Renuncias forzadas</p>
                </li>
                <li>
                    <p>• Discriminación Laboral</p>
                </li>
                <li>
                    <p>•  Cambio de condiciones de trabajo</p>
                </li>
                <li>
                    <p>•  Pagos en Negro</p>
                </li>
            ...
            <p>- Luego es muy dificil probar ilegalidad del acuerdo suscripto.</p>
